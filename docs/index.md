...
# Application
An application built from https://github.com/jdubrick-ai/june23-test-1 will be stored in [quay.io/jdubrick-ai/june23-test-1](https://quay.io/jdubrick-ai/june23-test-1) and deployed through GitOps. This application is accessible on port **8501**.